...
>
    <div class="space-y-6">
        <header class="flex items-start gap-4">
            <x-form.button href="{{ route('admin.profile.show') }}" variant="ghost" size="sm" icon="arrow-left" aria-label="Back to profile">Back to profile</x-form.button>
        ...
        <div class="grid gap-6 xl:grid-cols-2">
            ...
            <section class="flex flex-col border border-[var(--dash-border)] bg-[var(--dash-card)]">
                ...
                <footer class="border-t border-[var(--dash-border)] px-6 py-4"><x-form.button id="register-passkey" size="sm" icon="fingerprint" onclick="AppModal.open('passkey-name-modal')">Add passkey</x-form.button></footer>
            </section>
        </div>
