    ...
    <div class="max-w-3xl space-y-6">
        ...
        @if($step === 'basic')
            <form method="POST" action="{{ route('admin.applications.wizard.basic.store') }}" class="space-y-4 border border-[var(--dash-border)] bg-[var(--dash-card)] p-5">
                ...
                <button class="border border-[var(--dash-primary)] bg-[var(--dash-primary)] px-4 py-2 text-sm font-semibold text-[var(--dash-action-text)]">Continue</button>
            </form>
        ...
        @elseif($step === 'redirect')
            <form method="POST" action="{{ route('admin.applications.wizard.redirect.store') }}" class="space-y-4 border border-[var(--dash-border)] bg-[var(--dash-card)] p-5">
                ...
                <button class="border border-[var(--dash-primary)] bg-[var(--dash-primary)] px-4 py-2 text-sm font-semibold text-[var(--dash-action-text)]">Review</button>
            </form>
        @elseif($step === 'scopes')
        ...
        @else
            <div class="space-y-4 border border-[var(--dash-border)] bg-[var(--dash-card)] p-5">
                ...
                <form method="POST" action="{{ route('admin.applications.wizard.complete') }}">@csrf<button class="border border-[var(--dash-primary)] bg-[var(--dash-primary)] px-4 py-2 text-sm font-semibold text-[var(--dash-action-text)]">Create draft</button></form>
            </div>
        @endif
    </div>
</x-dashboard.layout>
