...
use App\Models\User;
use Vendor\LaravelAuthentication\Strategies\CustomIdentifierStrategy;
use Vendor\LaravelAuthentication\Strategies\EmailPasswordStrategy;
use Vendor\LaravelAuthentication\Strategies\PasskeyAuthenticationStrategy;
use Vendor\LaravelAuthentication\Strategies\UsernameOrEmailStrategy;
use Vendor\LaravelAuthentication\Strategies\UsernamePasswordStrategy;
...
return [
    ...
    */
    'login' => [
        ...
        'strategies' => [
            'username_or_email' => UsernameOrEmailStrategy::class,
            'email_password' => EmailPasswordStrategy::class,
            'username_password' => UsernamePasswordStrategy::class,
            'custom_identifier' => CustomIdentifierStrategy::class,
            'passkey' => PasskeyAuthenticationStrategy::class,
        ],
